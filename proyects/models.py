...
class Project(models.Model):
    ...
    factured_payment = MoneyField(max_digits=9, decimal_places=2,default_currency='CUP',default=0.0,verbose_name="Facturado")
    pending_payment = MoneyField(max_digits=9, decimal_places=2,default_currency='CUP',default=0.0,verbose_name="Pendiente")
